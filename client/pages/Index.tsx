  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden border-b">
        <div className="pointer-events-none absolute inset-0 -z-10 [mask-image:radial-gradient(70%_60%_at_50%_0%,black,transparent)] bg-[radial-gradient(1200px_400px_at_50%_-50px,theme(colors.primary/15),transparent)]" />
